...
public class PositionReport extends BaseMsgType{
    public static final PositionReport INSTANCE = new PositionReport();
    ...
    private PositionReport() {
        super(
            ...
            FieldTypes.PosReqID.required(false),
            FieldTypes.PosReqType.required(false),
            FieldTypes.SubscriptionRequestType.required(false),
            FieldTypes.TotalNumPosReports.required(false),
            FieldTypes.PosReqResult.required(false),
            ...
            FieldTypes.SettlPriceType.required(false),
            ...
            new BaseGroupType(
                ...
                FieldTypes.UnderlyingSettlPrice.required(false),
                FieldTypes.UnderlyingSettlPriceType.required(false),
                FieldTypes.UnderlyingDeliveryAmount.required(false),
                new BaseGroupType(
                    FieldTypes.NoUnderlyingAmounts.required(false),
                    FieldTypes.UnderlyingPayAmount.required(false),
                    FieldTypes.UnderlyingCollectAmount.required(false),
                    FieldTypes.UnderlyingSettlementDate.required(false),
                    FieldTypes.UnderlyingSettlementStatus.required(false)
                )
            ),
            new BaseGroupType(
            ...
            FieldTypes.RegistStatus.required(false),
            FieldTypes.DeliveryDate.required(false),
            FieldTypes.ModelType.required(false),
