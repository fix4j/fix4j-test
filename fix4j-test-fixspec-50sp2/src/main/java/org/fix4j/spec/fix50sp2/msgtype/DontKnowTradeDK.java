...
public class DontKnowTradeDK extends BaseMsgType{
    public static final DontKnowTradeDK INSTANCE = new DontKnowTradeDK();

    private DontKnowTradeDK() {
        super(
            "DontKnowTradeDK",
            "Q",
            "app",
            ...
            FieldTypes.DKReason.required(true),
