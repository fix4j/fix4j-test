...
public class CollateralReport extends BaseMsgType{
    public static final CollateralReport INSTANCE = new CollateralReport();

    private CollateralReport() {
        super(
            "CollateralReport",
            "BA",
            "app",
            FieldTypes.CollRptID.required(true),
            FieldTypes.CollInquiryID.required(false),
            FieldTypes.TransactTime.required(false),
            FieldTypes.CollApplType.required(false),
            FieldTypes.FinancialStatus.required(false),
            FieldTypes.CollStatus.required(true),
