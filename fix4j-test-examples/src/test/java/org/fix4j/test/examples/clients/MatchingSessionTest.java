...
import org.fix4j.test.examples.servers.TestServerToPriceAndFillOrders;
...
public class MatchingSessionTest {
    ...
    public void testMatchingSession() {
        ...
        final FixMessage logon = client.discardUntil(MsgTypes.Logon);
        ...
        final FixMessage quote = client.discardUntil(MsgTypes.MarketDataIncrementalRefresh, "262=request123|55=AUD/USD");
