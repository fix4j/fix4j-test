...
public class OrderMassActionRequest extends BaseMsgType{
    public static final OrderMassActionRequest INSTANCE = new OrderMassActionRequest();

    private OrderMassActionRequest() {
        super(
