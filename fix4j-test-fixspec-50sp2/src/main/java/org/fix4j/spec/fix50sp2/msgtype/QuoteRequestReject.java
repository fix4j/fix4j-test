...
public class QuoteRequestReject extends BaseMsgType{
    public static final QuoteRequestReject INSTANCE = new QuoteRequestReject();

    private QuoteRequestReject() {
        super(
            "QuoteRequestReject",
            "AG",
            "app",
            FieldTypes.QuoteReqID.required(true),
            FieldTypes.RFQReqID.required(false),
            FieldTypes.QuoteRequestRejectReason.required(true),
            FieldTypes.PrivateQuote.required(false),
            FieldTypes.RespondentType.required(false),
            ...
            new BaseGroupType(
                FieldTypes.NoRelatedSym.required(true),
                ...
                FieldTypes.QuoteRequestType.required(false),
                ...
                FieldTypes.QuotePriceType.required(false),
