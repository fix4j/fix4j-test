...
public class Email extends BaseMsgType{
    ...
    private Email() {
        super(
            ...
            "C",
            "app",
            FieldTypes.EmailThreadID.required(true),
            FieldTypes.EmailType.required(true),
            FieldTypes.OrigTime.required(false),
            FieldTypes.Subject.required(true),
            FieldTypes.EncodedSubjectLen.required(false),
            FieldTypes.EncodedSubject.required(false),
            new BaseGroupType(
