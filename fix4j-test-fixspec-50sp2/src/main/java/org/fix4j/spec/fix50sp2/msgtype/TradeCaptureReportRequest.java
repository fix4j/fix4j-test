...
public class TradeCaptureReportRequest extends BaseMsgType{
    public static final TradeCaptureReportRequest INSTANCE = new TradeCaptureReportRequest();
    ...
    private TradeCaptureReportRequest() {
        super(
            ...
            new BaseGroupType(
                FieldTypes.NoDates.required(false),
                FieldTypes.NoDates.required(false),
