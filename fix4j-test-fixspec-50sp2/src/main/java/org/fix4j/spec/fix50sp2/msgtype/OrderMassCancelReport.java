...
public class OrderMassCancelReport extends BaseMsgType{
    public static final OrderMassCancelReport INSTANCE = new OrderMassCancelReport();
    ...
    private OrderMassCancelReport() {
        super(
            ...
            FieldTypes.MassCancelRequestType.required(true),
            FieldTypes.MassCancelResponse.required(true),
            FieldTypes.MassCancelRejectReason.required(false),
