...
public class QuoteStatusReport extends BaseMsgType{
    public static final QuoteStatusReport INSTANCE = new QuoteStatusReport();

    private QuoteStatusReport() {
        super(
            "QuoteStatusReport",
            "AI",
            "app",
            FieldTypes.QuoteStatusReqID.required(false),
            ...
            FieldTypes.QuoteStatus.required(false),
