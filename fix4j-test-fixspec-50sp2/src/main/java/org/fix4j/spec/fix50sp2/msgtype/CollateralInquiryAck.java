...
public class CollateralInquiryAck extends BaseMsgType{
    public static final CollateralInquiryAck INSTANCE = new CollateralInquiryAck();

    private CollateralInquiryAck() {
        super(
            "CollateralInquiryAck",
            "BG",
            "app",
            FieldTypes.CollInquiryID.required(true),
            FieldTypes.CollInquiryStatus.required(true),
            FieldTypes.CollInquiryResult.required(false),
            new BaseGroupType(
