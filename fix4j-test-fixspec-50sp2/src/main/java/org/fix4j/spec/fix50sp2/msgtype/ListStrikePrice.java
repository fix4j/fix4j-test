...
public class ListStrikePrice extends BaseMsgType{
    public static final ListStrikePrice INSTANCE = new ListStrikePrice();

    private ListStrikePrice() {
        super(
            "ListStrikePrice",
            "m",
            "app",
            FieldTypes.ListID.required(true),
            FieldTypes.TotNoStrikes.required(true),
            FieldTypes.LastFragment.required(false),
            new BaseGroupType(
                FieldTypes.NoStrikes.required(true),
