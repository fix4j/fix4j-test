...
public class SecurityDefinitionUpdateReport extends BaseMsgType{
    public static final SecurityDefinitionUpdateReport INSTANCE = new SecurityDefinitionUpdateReport();

    private SecurityDefinitionUpdateReport() {
        super(
