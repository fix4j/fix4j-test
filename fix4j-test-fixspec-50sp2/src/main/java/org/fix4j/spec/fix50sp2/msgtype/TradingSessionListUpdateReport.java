...
public class TradingSessionListUpdateReport extends BaseMsgType{
    public static final TradingSessionListUpdateReport INSTANCE = new TradingSessionListUpdateReport();

    private TradingSessionListUpdateReport() {
        super(
