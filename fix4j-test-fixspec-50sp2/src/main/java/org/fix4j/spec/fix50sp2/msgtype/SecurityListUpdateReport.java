...
public class SecurityListUpdateReport extends BaseMsgType{
    public static final SecurityListUpdateReport INSTANCE = new SecurityListUpdateReport();

    private SecurityListUpdateReport() {
        super(
            ...
            FieldTypes.SecurityListID.required(false),
            FieldTypes.SecurityListRefID.required(false),
            FieldTypes.SecurityListDesc.required(false),
            FieldTypes.EncodedSecurityListDescLen.required(false),
            FieldTypes.EncodedSecurityListDesc.required(false),
            FieldTypes.SecurityListType.required(false),
            FieldTypes.SecurityListTypeSource.required(false),
