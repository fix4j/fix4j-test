...
public class ContraryIntentionReport extends BaseMsgType{
    public static final ContraryIntentionReport INSTANCE = new ContraryIntentionReport();

    private ContraryIntentionReport() {
        super(
            "ContraryIntentionReport",
            "BO",
            "app",
            FieldTypes.ContIntRptID.required(true),
            FieldTypes.TransactTime.required(false),
            FieldTypes.LateIndicator.required(false),
            FieldTypes.InputSource.required(false),
            ...
            new BaseGroupType(
                FieldTypes.NoExpiration.required(false),
                FieldTypes.ExpirationQtyType.required(false),
                FieldTypes.ExpQty.required(false)
            ),
