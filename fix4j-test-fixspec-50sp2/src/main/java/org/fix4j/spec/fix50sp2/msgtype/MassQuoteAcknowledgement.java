...
public class MassQuoteAcknowledgement extends BaseMsgType{
    public static final MassQuoteAcknowledgement INSTANCE = new MassQuoteAcknowledgement();

    private MassQuoteAcknowledgement() {
        super(
            "MassQuoteAcknowledgement",
            "b",
            "app",
            FieldTypes.QuoteReqID.required(false),
            FieldTypes.QuoteID.required(false),
            FieldTypes.QuoteStatus.required(true),
            FieldTypes.QuoteRejectReason.required(false),
            FieldTypes.QuoteResponseLevel.required(false),
            FieldTypes.QuoteType.required(false),
            FieldTypes.QuoteCancelType.required(false),
            new BaseGroupType(
            ...
            new BaseGroupType(
                FieldTypes.NoTargetPartyIDs.required(false),
                FieldTypes.TargetPartyID.required(false),
                FieldTypes.TargetPartyIDSource.required(false),
                FieldTypes.TargetPartyRole.required(false)
            ),
            ...
            new BaseGroupType(
                FieldTypes.NoQuoteSets.required(false),
                FieldTypes.QuoteSetID.required(false),
                FieldTypes.QuoteSetValidUntilTime.required(false),
                ...
                FieldTypes.TotNoQuoteEntries.required(false),
                FieldTypes.TotNoCxldQuotes.required(false),
                FieldTypes.TotNoAccQuotes.required(false),
                FieldTypes.TotNoRejQuotes.required(false),
                FieldTypes.LastFragment.required(false),
                new BaseGroupType(
                    FieldTypes.NoQuoteEntries.required(false),
