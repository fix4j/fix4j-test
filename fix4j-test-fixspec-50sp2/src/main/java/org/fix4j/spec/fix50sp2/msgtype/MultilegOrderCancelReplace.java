...
public class MultilegOrderCancelReplace extends BaseMsgType{
    public static final MultilegOrderCancelReplace INSTANCE = new MultilegOrderCancelReplace();

    private MultilegOrderCancelReplace() {
        super(
            ...
            FieldTypes.SwapPoints.required(false),
            new BaseGroupType(
                FieldTypes.NoLegs.required(true),
            ...
            FieldTypes.MultiLegRptTypeReq.required(false)
        );
    }
}