...
public class Confirmation extends BaseMsgType{
    ...
    private Confirmation() {
        super(
            ...
            FieldTypes.ConfirmRefID.required(false),
            FieldTypes.ConfirmReqID.required(false),
            FieldTypes.ConfirmTransType.required(true),
            FieldTypes.ConfirmType.required(true),
            FieldTypes.CopyMsgIndicator.required(false),
            FieldTypes.LegalConfirm.required(false),
            FieldTypes.ConfirmStatus.required(true),
            new BaseGroupType(
            ...
            FieldTypes.AllocQty.required(true),
            ...
            new BaseGroupType(
                FieldTypes.NoCapacities.required(true),
                FieldTypes.OrderCapacity.required(true),
                FieldTypes.OrderRestrictions.required(false),
                FieldTypes.OrderCapacityQty.required(true)
            ),
            FieldTypes.AllocAccount.required(true),
            ...
            FieldTypes.ReportedPx.required(false),
            ...
            FieldTypes.GrossTradeAmt.required(true),
            ...
            FieldTypes.NetMoney.required(true),
            FieldTypes.MaturityNetMoney.required(false),
            ...
            FieldTypes.SharedCommission.required(false),
            new BaseGroupType(
