...
public class CollateralRequest extends BaseMsgType{
    public static final CollateralRequest INSTANCE = new CollateralRequest();

    private CollateralRequest() {
        super(
            "CollateralRequest",
            "AX",
            "app",
            FieldTypes.CollReqID.required(true),
