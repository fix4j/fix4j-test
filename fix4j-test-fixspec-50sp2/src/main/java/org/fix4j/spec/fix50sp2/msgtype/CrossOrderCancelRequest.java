...
public class CrossOrderCancelRequest extends BaseMsgType{
    public static final CrossOrderCancelRequest INSTANCE = new CrossOrderCancelRequest();

    private CrossOrderCancelRequest() {
        super(
