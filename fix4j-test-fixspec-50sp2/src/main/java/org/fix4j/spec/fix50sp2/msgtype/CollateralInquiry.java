...
public class CollateralInquiry extends BaseMsgType{
    public static final CollateralInquiry INSTANCE = new CollateralInquiry();

    private CollateralInquiry() {
        super(
            "CollateralInquiry",
            "BB",
            "app",
            FieldTypes.CollInquiryID.required(true),
            new BaseGroupType(
                FieldTypes.NoCollInquiryQualifier.required(false),
                FieldTypes.CollInquiryQualifier.required(false)
            ),
