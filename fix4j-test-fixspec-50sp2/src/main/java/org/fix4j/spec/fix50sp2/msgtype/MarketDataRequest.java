...
public class MarketDataRequest extends BaseMsgType{
    public static final MarketDataRequest INSTANCE = new MarketDataRequest();
    ...
    private MarketDataRequest() {
        super(
            ...
            FieldTypes.MarketDepth.required(true),
            FieldTypes.MDUpdateType.required(false),
            FieldTypes.AggregatedBook.required(false),
            FieldTypes.OpenCloseSettlFlag.required(false),
            FieldTypes.Scope.required(false),
            FieldTypes.MDImplicitDelete.required(false),
            new BaseGroupType(
                FieldTypes.NoMDEntryTypes.required(true),
            ...
            FieldTypes.ApplQueueAction.required(false),
            FieldTypes.ApplQueueMax.required(false),
