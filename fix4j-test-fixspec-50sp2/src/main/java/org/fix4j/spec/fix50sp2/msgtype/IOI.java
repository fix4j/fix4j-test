...
public class IOI extends BaseMsgType{
    public static final IOI INSTANCE = new IOI();
    ...
    private IOI() {
        super(
            ...
            FieldTypes.IOIID.required(true),
            FieldTypes.IOITransType.required(true),
            FieldTypes.IOIRefID.required(false),
            ...
            FieldTypes.IOIQty.required(true),
            ...
            new BaseGroupType(
                ...
                FieldTypes.LegIOIQty.required(false),
                new BaseGroupType(
            ...
            FieldTypes.IOIQltyInd.required(false),
            FieldTypes.IOINaturalFlag.required(false),
            new BaseGroupType(
                FieldTypes.NoIOIQualifiers.required(false),
                FieldTypes.IOIQualifier.required(false)
            ),
