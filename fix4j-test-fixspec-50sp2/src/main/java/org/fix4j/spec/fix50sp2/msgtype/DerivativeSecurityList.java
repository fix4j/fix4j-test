...
public class DerivativeSecurityList extends BaseMsgType{
    public static final DerivativeSecurityList INSTANCE = new DerivativeSecurityList();

    private DerivativeSecurityList() {
        super(
