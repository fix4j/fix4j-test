...
public class PositionMaintenanceRequest extends BaseMsgType{
    public static final PositionMaintenanceRequest INSTANCE = new PositionMaintenanceRequest();

    private PositionMaintenanceRequest() {
        super(
