...
public class SecurityStatusRequest extends BaseMsgType{
    public static final SecurityStatusRequest INSTANCE = new SecurityStatusRequest();

    private SecurityStatusRequest() {
        super(
            "SecurityStatusRequest",
            "e",
            "app",
            FieldTypes.SecurityStatusReqID.required(true),
