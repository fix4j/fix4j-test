...
public class TradeCaptureReportRequestAck extends BaseMsgType{
    public static final TradeCaptureReportRequestAck INSTANCE = new TradeCaptureReportRequestAck();

    private TradeCaptureReportRequestAck() {
        super(
            "TradeCaptureReportRequestAck",
            "AQ",
            "app",
            FieldTypes.TradeRequestID.required(true),
            ...
            FieldTypes.TradeRequestType.required(true),
            FieldTypes.SubscriptionRequestType.required(false),
            FieldTypes.TotNumTradeReports.required(false),
            FieldTypes.TradeRequestResult.required(true),
            FieldTypes.TradeRequestStatus.required(true),
