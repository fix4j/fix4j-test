...
public class News extends BaseMsgType{
    ...
    private News() {
        super(
            ...
            "B",
            "app",
            FieldTypes.NewsID.required(false),
            FieldTypes.NewsCategory.required(false),
            FieldTypes.LanguageCode.required(false),
            ...
            new BaseGroupType(
                FieldTypes.NoNewsRefIDs.required(false),
                FieldTypes.NewsRefID.required(false),
                FieldTypes.NewsRefType.required(false)
            ),
            FieldTypes.OrigTime.required(false),
            FieldTypes.Urgency.required(false),
            FieldTypes.Headline.required(true),
            FieldTypes.EncodedHeadlineLen.required(false),
            FieldTypes.EncodedHeadline.required(false),
            new BaseGroupType(
            ...
            new BaseGroupType(
                FieldTypes.NoLinesOfText.required(true),
                FieldTypes.Text.required(true),
                FieldTypes.EncodedTextLen.required(false),
                FieldTypes.EncodedText.required(false)
            ),
            FieldTypes.URLLink.required(false),
