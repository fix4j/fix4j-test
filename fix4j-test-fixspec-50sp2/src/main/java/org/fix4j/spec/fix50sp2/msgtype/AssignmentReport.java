...
public class AssignmentReport extends BaseMsgType{
    public static final AssignmentReport INSTANCE = new AssignmentReport();
    ...
    private AssignmentReport() {
        super(
            ...
            FieldTypes.AsgnRptID.required(true),
            FieldTypes.PosReqID.required(false),
            FieldTypes.TotNumAssignmentReports.required(false),
            ...
            FieldTypes.AssignmentMethod.required(false),
            FieldTypes.AssignmentUnit.required(false),
            FieldTypes.OpenInterest.required(false),
            FieldTypes.ExerciseMethod.required(false),
