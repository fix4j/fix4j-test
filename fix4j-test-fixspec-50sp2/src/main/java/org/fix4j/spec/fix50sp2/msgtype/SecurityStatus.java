...
public class SecurityStatus extends BaseMsgType{
    ...
    private SecurityStatus() {
        super(
            ...
            FieldTypes.SecurityStatusReqID.required(false),
            ...
            FieldTypes.SecurityTradingEvent.required(false),
            FieldTypes.FinancialStatus.required(false),
            FieldTypes.CorporateAction.required(false),
            FieldTypes.HaltReason.required(false),
            FieldTypes.InViewOfCommon.required(false),
            FieldTypes.DueToRelated.required(false),
            FieldTypes.MDBookType.required(false),
            FieldTypes.MarketDepth.required(false),
            FieldTypes.BuyVolume.required(false),
            FieldTypes.SellVolume.required(false),
            ...
            FieldTypes.Adjustment.required(false),
