...
public class ExecutionAcknowledgement extends BaseMsgType{
    public static final ExecutionAcknowledgement INSTANCE = new ExecutionAcknowledgement();

    private ExecutionAcknowledgement() {
        super(
            ...
            FieldTypes.ExecAckStatus.required(true),
            FieldTypes.ExecID.required(true),
            FieldTypes.DKReason.required(false),
