...
public class AdjustedPositionReport extends BaseMsgType{
    public static final AdjustedPositionReport INSTANCE = new AdjustedPositionReport();

    private AdjustedPositionReport() {
        super(
            "AdjustedPositionReport",
            "BL",
            "app",
            FieldTypes.PosMaintRptID.required(true),
            FieldTypes.PosReqType.required(false),
            FieldTypes.ClearingBusinessDate.required(true),
            FieldTypes.SettlSessID.required(false),
            FieldTypes.SettlPrice.required(false),
            FieldTypes.PosMaintRptRefID.required(false),
            new BaseGroupType(
            ...
            new BaseGroupType(
                FieldTypes.NoPositions.required(false),
                FieldTypes.PosType.required(false),
                FieldTypes.LongQty.required(false),
                FieldTypes.ShortQty.required(false),
                FieldTypes.PosQtyStatus.required(false),
                FieldTypes.QuantityDate.required(false),
                new BaseGroupType(
            ...
            new BaseGroupType(
                FieldTypes.NoRelatedSym.required(false),
            ...
            FieldTypes.PriorSettlPrice.required(false)
        );
    }
}