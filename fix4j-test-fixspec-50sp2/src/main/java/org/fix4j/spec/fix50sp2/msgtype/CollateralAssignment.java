...
public class CollateralAssignment extends BaseMsgType{
    public static final CollateralAssignment INSTANCE = new CollateralAssignment();

    private CollateralAssignment() {
        super(
            "CollateralAssignment",
            "AY",
            "app",
            FieldTypes.CollAsgnID.required(true),
            FieldTypes.CollReqID.required(false),
            FieldTypes.CollAsgnReason.required(true),
            FieldTypes.CollAsgnTransType.required(true),
            FieldTypes.CollAsgnRefID.required(false),
