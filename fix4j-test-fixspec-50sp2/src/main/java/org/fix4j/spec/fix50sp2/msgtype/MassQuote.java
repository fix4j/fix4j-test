...
public class MassQuote extends BaseMsgType{
    public static final MassQuote INSTANCE = new MassQuote();
    ...
    private MassQuote() {
        super(
            ...
            FieldTypes.QuoteID.required(true),
            ...
            FieldTypes.DefBidSize.required(false),
            FieldTypes.DefOfferSize.required(false),
            new BaseGroupType(
                FieldTypes.NoQuoteSets.required(true),
                FieldTypes.QuoteSetID.required(true),
                ...
                FieldTypes.TotNoQuoteEntries.required(true),
                FieldTypes.LastFragment.required(false),
                new BaseGroupType(
                    FieldTypes.NoQuoteEntries.required(true),
                    FieldTypes.QuoteEntryID.required(true),
