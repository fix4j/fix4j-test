...
public class StreamAssignmentRequest extends BaseMsgType{
    public static final StreamAssignmentRequest INSTANCE = new StreamAssignmentRequest();

    private StreamAssignmentRequest() {
        super(
            "StreamAssignmentRequest",
            "CC",
            "app",
            FieldTypes.StreamAsgnReqID.required(true),
            FieldTypes.StreamAsgnReqType.required(true),
            new BaseGroupType(
