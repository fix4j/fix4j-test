...
public class CrossOrderCancelReplaceRequest extends BaseMsgType{
    public static final CrossOrderCancelReplaceRequest INSTANCE = new CrossOrderCancelReplaceRequest();

    private CrossOrderCancelReplaceRequest() {
        super(
            ...
            FieldTypes.OrigCrossID.required(true),
