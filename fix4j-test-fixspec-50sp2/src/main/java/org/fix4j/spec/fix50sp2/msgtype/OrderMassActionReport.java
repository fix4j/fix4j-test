...
public class OrderMassActionReport extends BaseMsgType{
    public static final OrderMassActionReport INSTANCE = new OrderMassActionReport();

    private OrderMassActionReport() {
        super(
            ...
            FieldTypes.MassActionReportID.required(true),
            FieldTypes.MassActionType.required(true),
            FieldTypes.MassActionScope.required(true),
            FieldTypes.MassActionResponse.required(true),
            FieldTypes.MassActionRejectReason.required(false),
            FieldTypes.TotalAffectedOrders.required(false),
            new BaseGroupType(
                FieldTypes.NoAffectedOrders.required(false),
                FieldTypes.OrigClOrdID.required(false),
                FieldTypes.AffectedOrderID.required(false),
                FieldTypes.AffectedSecondaryOrderID.required(false)
            ),
            new BaseGroupType(
                FieldTypes.NoNotAffectedOrders.required(false),
                FieldTypes.NotAffOrigClOrdID.required(false),
                FieldTypes.NotAffectedOrderID.required(false)
            ),
