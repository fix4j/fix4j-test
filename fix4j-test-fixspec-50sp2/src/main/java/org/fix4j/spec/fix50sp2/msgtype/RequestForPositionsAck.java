...
public class RequestForPositionsAck extends BaseMsgType{
    public static final RequestForPositionsAck INSTANCE = new RequestForPositionsAck();

    private RequestForPositionsAck() {
        super(
            ...
            FieldTypes.PosReqResult.required(true),
            FieldTypes.PosReqStatus.required(true),
