...
public class CollateralResponse extends BaseMsgType{
    public static final CollateralResponse INSTANCE = new CollateralResponse();

    private CollateralResponse() {
        super(
            "CollateralResponse",
            "AZ",
            "app",
            FieldTypes.CollRespID.required(true),
            FieldTypes.CollAsgnID.required(false),
            FieldTypes.CollReqID.required(false),
            FieldTypes.CollAsgnReason.required(false),
            FieldTypes.CollAsgnTransType.required(false),
            FieldTypes.CollAsgnRespType.required(true),
            FieldTypes.CollAsgnRejectReason.required(false),
            FieldTypes.TransactTime.required(true),
            FieldTypes.CollApplType.required(false),
            ...
            new BaseGroupType(
                FieldTypes.NoTrades.required(false),
            ...
            new BaseGroupType(
                ...
                FieldTypes.CollAction.required(false)
            ),
            FieldTypes.MarginExcess.required(false),
            FieldTypes.TotalNetValue.required(false),
            FieldTypes.CashOutstanding.required(false),
            new BaseGroupType(
