...
public class MarketDataIncrementalRefresh extends BaseMsgType{
    public static final MarketDataIncrementalRefresh INSTANCE = new MarketDataIncrementalRefresh();

    private MarketDataIncrementalRefresh() {
        super(
            ...
            new BaseGroupType(
                ...
                FieldTypes.MDUpdateAction.required(true),
                FieldTypes.DeleteReason.required(false),
                FieldTypes.MDSubBookType.required(false),
                FieldTypes.MarketDepth.required(false),
                FieldTypes.MDEntryType.required(false),
                FieldTypes.MDEntryID.required(false),
                FieldTypes.MDEntryRefID.required(false),
                ...
                new BaseGroupType(
                    FieldTypes.NoStatsIndicators.required(false),
                    FieldTypes.StatsType.required(false)
                )
            ),
