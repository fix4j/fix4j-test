...
public class SecurityDefinitionRequest extends BaseMsgType{
    public static final SecurityDefinitionRequest INSTANCE = new SecurityDefinitionRequest();

    private SecurityDefinitionRequest() {
        super(
            "SecurityDefinitionRequest",
            "c",
            "app",
            FieldTypes.SecurityReqID.required(true),
            FieldTypes.SecurityRequestType.required(true),
