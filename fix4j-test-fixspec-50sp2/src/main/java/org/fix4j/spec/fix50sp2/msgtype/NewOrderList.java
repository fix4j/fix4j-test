...
public class NewOrderList extends BaseMsgType{
    public static final NewOrderList INSTANCE = new NewOrderList();

    private NewOrderList() {
        super(
            "NewOrderList",
            "E",
            "app",
            ...
            FieldTypes.ListExecInstType.required(false),
            FieldTypes.ListExecInst.required(false),
            FieldTypes.ContingencyType.required(false),
            FieldTypes.EncodedListExecInstLen.required(false),
            FieldTypes.EncodedListExecInst.required(false),
            FieldTypes.AllowableOneSidednessPct.required(false),
            FieldTypes.AllowableOneSidednessValue.required(false),
            FieldTypes.AllowableOneSidednessCurr.required(false),
            ...
            new BaseGroupType(
                ...
                FieldTypes.ListSeqNo.required(true),
                FieldTypes.ClOrdLinkID.required(false),
                FieldTypes.SettlInstMode.required(false),
                new BaseGroupType(
                ...
                FieldTypes.Price2.required(false),
