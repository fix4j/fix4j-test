...
public class DerivativeSecurityListUpdateReport extends BaseMsgType{
    public static final DerivativeSecurityListUpdateReport INSTANCE = new DerivativeSecurityListUpdateReport();

    private DerivativeSecurityListUpdateReport() {
        super(
            ...
            FieldTypes.SecurityRequestResult.required(false),
            FieldTypes.SecurityUpdateAction.required(false),
            ...
            new BaseGroupType(
                FieldTypes.NoDerivativeInstrAttrib.required(false),
                FieldTypes.DerivativeInstrAttribType.required(false),
                FieldTypes.DerivativeInstrAttribValue.required(false)
            ),
            new BaseGroupType(
            ...
            FieldTypes.TotNoRelatedSym.required(false),
            FieldTypes.LastFragment.required(false),
            new BaseGroupType(
                FieldTypes.NoRelatedSym.required(false),
                FieldTypes.ListUpdateAction.required(false),
                ...
                FieldTypes.RelSymTransactTime.required(false),
                ...
                FieldTypes.SecondaryPriceLimitType.required(false),
                FieldTypes.SecondaryLowLimitPrice.required(false),
                FieldTypes.SecondaryHighLimitPrice.required(false),
                FieldTypes.SecondaryTradingReferencePrice.required(false),
                new BaseGroupType(
