...
public class PositionMaintenanceReport extends BaseMsgType{
    public static final PositionMaintenanceReport INSTANCE = new PositionMaintenanceReport();

    private PositionMaintenanceReport() {
        super(
            "PositionMaintenanceReport",
            "AM",
            "app",
            FieldTypes.PosMaintRptID.required(true),
            FieldTypes.PosTransType.required(true),
            FieldTypes.PosReqID.required(false),
            FieldTypes.PosMaintAction.required(true),
            FieldTypes.OrigPosReqRefID.required(false),
            FieldTypes.PosMaintStatus.required(true),
            FieldTypes.PosMaintResult.required(false),
            ...
            FieldTypes.ContraryInstructionIndicator.required(false),
            FieldTypes.PriorSpreadIndicator.required(false),
            new BaseGroupType(
            ...
            FieldTypes.AdjustmentType.required(false),
            FieldTypes.ThresholdAmount.required(false),
