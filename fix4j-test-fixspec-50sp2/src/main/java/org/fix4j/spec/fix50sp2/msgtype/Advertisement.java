...
public class Advertisement extends BaseMsgType{
    ...
    private Advertisement() {
        super(
            ...
            "7",
            "app",
            FieldTypes.AdvId.required(true),
            FieldTypes.AdvTransType.required(true),
            FieldTypes.AdvRefID.required(false),
            ...
            FieldTypes.AdvSide.required(true),
