...
public class StreamAssignmentReport extends BaseMsgType{
    public static final StreamAssignmentReport INSTANCE = new StreamAssignmentReport();

    private StreamAssignmentReport() {
        super(
            "StreamAssignmentReport",
            "CD",
            "app",
            FieldTypes.StreamAsgnRptID.required(true),
            FieldTypes.StreamAsgnReqType.required(false),
            FieldTypes.StreamAsgnReqID.required(false),
            new BaseGroupType(
                FieldTypes.NoAsgnReqs.required(false),
                new BaseGroupType(
                ...
                new BaseGroupType(
                    ...
                    FieldTypes.StreamAsgnType.required(false),
