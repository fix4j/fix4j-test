...
public class OrderMassStatusRequest extends BaseMsgType{
    public static final OrderMassStatusRequest INSTANCE = new OrderMassStatusRequest();

    private OrderMassStatusRequest() {
        super(
            "OrderMassStatusRequest",
            "AF",
            "app",
            FieldTypes.MassStatusReqID.required(true),
            FieldTypes.MassStatusReqType.required(true),
            new BaseGroupType(
